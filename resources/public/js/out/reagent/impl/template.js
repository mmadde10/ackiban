...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5252__auto__,writer__5253__auto__,opt__5254__auto__){
return cljs.core._write.call(null,writer__5253__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4654__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4654__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4654__auto__)){
return or__4654__auto__;
} else {
...
var G__12790 = o;
(G__12790[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_12794 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_12794))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12794)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4642__auto__ = (node === document.activeElement);
if(and__4642__auto__){
var and__4642__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4642__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__12797 = jsprops;
(G__12797["defaultValue"] = value);

(G__12797["onChange"] = ((function (G__12797,v,value,on_change){
return (function (p1__12795_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12795_SHARP_);
});})(G__12797,v,value,on_change))
);
...
var vec__12799 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12799,(0),null);
var id = cljs.core.nth.call(null,vec__12799,(1),null);
var class$ = cljs.core.nth.call(null,vec__12799,(2),null);
...
var temp__4427__auto__ = (function (){var G__12803 = cljs.core.meta.call(null,v);
var G__12803__$1 = (((G__12803 == null))?null:reagent.impl.template.get_key.call(null,G__12803));
return G__12803__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12805_12806 = v;
var G__12805_12807__$1 = (((G__12805_12806 == null))?null:reagent.impl.template.key_from_vec.call(null,G__12805_12806));
var G__12805_12808__$2 = (((G__12805_12807__$1 == null))?null:(jsprops["key"] = G__12805_12807__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__12811 = cljs.core.meta.call(null,argv);
var G__12811__$1 = (((G__12811 == null))?null:reagent.impl.template.get_key.call(null,G__12811));
return G__12811__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__12812 = (((jsprops == null))?{}:jsprops);
(G__12812["key"] = key);
...
var G__12813 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12813;
continue;
}
} else {
...
var n__5557__auto___12814 = a.length;
var i_12815 = (0);
while(true){
if((i_12815 < n__5557__auto___12814)){
(a[i_12815] = reagent.impl.template.as_element.call(null,(a[i_12815])));
...
var a = cljs.core.into_array.call(null,s);
var n__5557__auto___12817 = a.length;
var i_12818 = (0);
while(true){
if((i_12818 < n__5557__auto___12817)){
var val_12819 = (a[i_12818]);
if((cljs.core.vector_QMARK_.call(null,val_12819)) && ((reagent.impl.template.key_from_vec.call(null,val_12819) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12818] = reagent.impl.template.as_element.call(null,val_12819));
...
if(cljs.core.truth_((function (){var and__4642__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4642__auto__){
return (ctx["no-key"]);
} else {
return and__4642__auto__;
...
var G__12822 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12822) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12822){
