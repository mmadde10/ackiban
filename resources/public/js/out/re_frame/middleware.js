...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__13119){
...
return cljs.core.get_in.call(null,new_db,p1__13120_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__13121_SHARP_){
return cljs.core.get_in.call(null,db,p1__13121_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__13122__i = 0, G__13122__a = new Array(arguments.length -  2);
while (G__13122__i < G__13122__a.length) {G__13122__a[G__13122__i] = arguments[G__13122__i + 2]; ++G__13122__i;}
  in_paths = new cljs.core.IndexedSeq(G__13122__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__13123){
var f = cljs.core.first(arglist__13123);
arglist__13123 = cljs.core.next(arglist__13123);
var out_path = cljs.core.first(arglist__13123);
var in_paths = cljs.core.rest(arglist__13123);
